...
src_directory = '/mnt/share/homes/bcreiner/repos/tropical_cyclone_risk'
base_directory = '/mnt/team/rapidresponse/pub/tropical-storms/data/cmip6/test_run'
output_directory = '/mnt/team/rapidresponse/pub/tropical-storms/data/cmip6/test_run'
exp_name = 'test'
...
# exp_prefix = 'era5' #GFDL-CM4_ssp126_r1i1p1f1'
exp_prefix = 'MRI-ESM2-0_ssp126_r1i1p1f1'
file_type = 'netcdf' #grib
...
"""
start_year = 2075                     # year to start downscaling
start_month = 1                       # month of start_year to start downscaling
end_year = 2084                       # year to stop downscaling
